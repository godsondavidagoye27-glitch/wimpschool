...
- **SQL Scripts**: `supabase/policies.sql` - Canonical RLS policy setup
- **Auth Code**: `js/auth.js` - Now displays banner when RLS blocks user_roles access
...
| `supabase/policies.sql` | Security policies for authenticated access |
